...
```{r echo=FALSE, fig.alt = "This table lists the various courses available from the ITN including ones under development that will be available in the future. Choosing Genomics Tools is highlighted because this workshop is adapted from that larger course. For more info on and to access any of these courses, visit itcr training dot org", fig.link="https://www.itcrtraining.org/courses"}
